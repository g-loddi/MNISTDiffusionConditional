...
class MNISTDiffusion(nn.Module):
    def __init__(self,image_size,in_channels,time_embedding_dim=256, contex_embedding_dim = 256, labels = 10, timesteps=1000, base_dim=32,dim_mults= [1, 2, 4, 8]):
        super().__init__()
    ...
    def sampling(self,n_samples, samples_target, clipped_reverse_diffusion=True,device="cuda"):
        ...
        samples_target = torch.tensor(samples_target, dtype=torch.long, device=device)
